...
INSERT INTO civilizaciones (nombre, bonificacion) VALUES
('Aztecas', 'Infantería fuerte, monjes más eficaces'),
('Británicos', 'Arqueros de tiro largo, centros urbanos más baratos'),
('Bizantinos', 'Edificios más resistentes, unidades defensivas baratas'),
('Chinos', 'Comienzan con más aldeanos pero menos recursos'),
('Francos', 'Caballería poderosa, centros urbanos más baratos'),
('Godos', 'Infantería barata y rápida de producir'),
('Japoneses', 'Infantería de ataque rápido, pesca eficiente'),
('Mongoles', 'Arqueros a caballo veloces, cazadores eficientes'),
('Persas', 'Economía fuerte, elefantes de guerra'),
('Sarracenos', 'Comercio eficiente, arqueros a camello'),
('Teutones', 'Unidades defensivas fuertes, monjes potentes'),
('Turcos', 'Pólvora avanzada, oro abundante'),
('Vikingos', 'Infantería más rápida, barcos económicos'),
('Búlgaros', 'Infantería fuerte, herrería gratis'),
('Cumanos', 'Desarrollan edificios únicos, movilidad temprana'),
('Lituanos', 'Bonificación por reliquias, caballería fuerte'),
('Polacos', 'Caballería con escudo, economía basada en granjas'),
('Burgundios', 'Tecnologías económicas tempranas'),
('Sicilianos', 'Daño reducido, construyen donjons'),
('Bohemios', 'Pólvora y monjes mejorados'),
('Hindustanis', 'Economía eficiente, unidades de pólvora avanzadas'),
('Dravídicos', 'Fuerza naval y elefantes únicos'),
('Bengalíes', 'Elefantes resistentes, monjes avanzados'),
('Gurjaras', 'Economía de pastoreo, unidades montadas únicas');
...
('Balística', 'Mejora la puntería de arqueros', 300, 0, 175, 0, 6),
